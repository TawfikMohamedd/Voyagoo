...
namespace Voyagoo.Persistence.Migrations
{
    ...
    public partial class SeedIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "IsOtpVerified", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PasswordResetOtp", "PasswordResetOtpExpiry", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "6dc6528a-b280-4770-9eae-82671ee81ef7", 0, "99d2bbc6-bc54-4248-a172-a77de3ae4430", "admin@Voyago.com", true, "Voyago", false, "Admin", false, null, "ADMIN@VOYAGO.COM", "ADMIN@VOYAGO.COM", "AQAAAAIAAYagAAAAEIH5xrGsWMUmk6+dwcrr7valg/zLJDfqaBl9s2UTTEvBFg7FTRfkoGOq4R7tnJaBfw==", null, null, null, false, "55BF92C9EF0249CDA210D85D1A851BC9", false, "admin@Voyago.com" });
