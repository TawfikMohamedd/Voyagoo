...
namespace Voyagoo.Persistence.Migrations
{
    ...
    [Migration("20260620014501_updatePass")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voyagoo.Entities.Attractions.Attraction", b =>
                {
                    ...
                    b.Property<int>("YearOfInscription")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voyagoo.Entities.BudgetPlanning.BudgetPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AttractionBudget")
                        .HasColumnType("decimal(10,2)");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("HotelBudget")
                        .HasColumnType("decimal(10,2)");

                    b.Property<int?>("HotelId")
                        .HasColumnType("int");

                    b.Property<string>("HotelNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<decimal>("RestaurantBudget")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Voyagoo.Entities.BudgetPlanning.BudgetPlanAttraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AttractionNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("BudgetPlanAttractions");
                });

            modelBuilder.Entity("Voyagoo.Entities.BudgetPlanning.BudgetPlanRestaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("EstimatedPriceSnapshot")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.ToTable("BudgetPlanRestaurants");
                });
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.BookingFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1001,
                            Icon = "full-board-icon",
                            Name = "Full Board"
                        },
                        new
                        {
                            Id = 1002,
                            Icon = "half-board-icon",
                            Name = "Half Board"
                        });
                });

            modelBuilder.Entity("Voyagoo.Entities.Hotels.Hotel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelBooking", b =>
                {
                    ...
                    b.Property<decimal>("BoardsTotal")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelBookingFeature", b =>
                {
                    ...
                    b.Property<int>("BookingFeatureId")
                        .HasColumnType("int");

                    b.Property<decimal>("Price")
                        .HasColumnType("decimal(10,2)");

                    b.HasKey("HotelId", "BookingFeatureId");

                    b.HasIndex("BookingFeatureId");

                    b.ToTable("HotelBookingFeatures");
                });

            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelBookingFeatureSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HotelBookingFeatureSelections");
                });

            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelBookingRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelFeatureMap", b =>
                {
                    b.Property<int>("HotelId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("HotelId", "HotelFeatureId");

                    b.HasIndex("HotelFeatureId");

                    b.ToTable("HotelFeatureMaps");
                });
            ...
            modelBuilder.Entity("Voyagoo.Entities.BudgetPlanning.BudgetPlan", b =>
                {
                    b.HasOne("Voyagoo.Entities.Hotels.Hotel", "Hotel")
                        .WithMany()
            ...
            modelBuilder.Entity("Voyagoo.Entities.BudgetPlanning.BudgetPlanAttraction", b =>
                {
                    ...
                    b.HasOne("Voyagoo.Entities.BudgetPlanning.BudgetPlan", "BudgetPlan")
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelBookingFeature", b =>
                {
                    b.HasOne("Voyagoo.Entities.Hotels.BookingFeature", "BookingFeature")
                        .WithMany("HotelBookingFeatures")
                        .HasForeignKey("BookingFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Voyagoo.Entities.Hotels.Hotel", "Hotel")
                        .WithMany("BookingFeatures")
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BookingFeature");
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.HotelFeatureMap", b =>
                {
                    b.HasOne("Voyagoo.Entities.Hotels.HotelFeature", "HotelFeature")
            ...
            modelBuilder.Entity("Voyagoo.Entities.Hotels.BookingFeature", b =>
                {
                    b.Navigation("HotelBookingFeatures");
                });

            modelBuilder.Entity("Voyagoo.Entities.Hotels.Hotel", b =>
                {
                    b.Navigation("BookingFeatures");
